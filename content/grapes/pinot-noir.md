...
Pinot needs qualification: the surviving text condemns [Gamay](gamay.md) and
orders its removal without naming a preferred replacement.[^1]
...
cool climate can provide a longer, more gradual season; balanced grapes still
depend on the site, weather, and harvest date.

Its small berries commonly form compact clusters, increasing disease risk.
...
disease susceptibility. Looser-clustered clones,
[canopy management](../concepts/canopy-management.md), crop level, and an open,
well-drained site can reduce some pressure.
...
and crop load change the heat, light, and water experienced by the fruit. In a
...
condition, and phenolic maturity. Fermenting crushed berries on their skins
supplies colour and tannin; the duration and force of extraction can keep the
result delicate or make it firmer. [Whole-cluster
fermentation](../concepts/whole-cluster-fermentation.md) introduces stems as
well as intact berries and can change tannin, aroma, and the course of
fermentation. Destemming, vessel choice, oxygen exposure, [new or used
oak](../concepts/oak-maturation.md), and bottle age add further variation.
Younger wines often suggest red fruit and flowers, while savoury character can
...
Pinot Noir by the [traditional
method](../styles/traditional-method-sparkling-wine.md). Shorter contact can
give rosé; longer contact produces red wine. Harvest and skin contact begin
shaping the style before fermentation.

## Where it is grown

Burgundy shows Pinot Noir as still red wine tied to named places. Across the
Côte d'Or and other Burgundian districts, exposure, soil depth, elevation,
vintage, crop, and cellar practice can produce wines of very different weight
and tannic shape. Wines from each named place still vary by producer and
vintage.
...
colour. Burgundy and Champagne apply different harvest and cellar goals to the
same early-ripening grape.
