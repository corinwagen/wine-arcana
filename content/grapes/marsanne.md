...
![A golden grape cluster hangs below a broad green vine leaf.](../../media/images/grapes/marsanne-ampelography.jpg "Marsanne, illustrated by Jules Troncy for Viala and Vermorel's Ampélographie.")

## Viticulture

Marsanne is a mid-ripening variety with large clusters and small, golden to
red-tinged berries. It is vigorous, particularly on fertile soils, and
performs well on the warm, rocky sites common in the northern Côtes du
Rhône.[^1] Those traits make the harvest a balance between ripeness and
freshness. A warm site or a late harvest can push the wine toward greater
alcohol and broader texture while leaving less acid to give it lift. Cooler
exposure, water availability, crop level, and the season can shift that
balance.

Fertile soil can support more vegetative growth and fruit
...
the finish.[^1] Picking, fermentation, lees contact, wood, alcohol, and bottle
condition can change the balance between fruit, texture, freshness, and
savoury development.
...
harvest, the same grape can feel more lifted.
...
Marsanne's breadth makes oxygen and maturation choices consequential.
Fermenting or ageing in neutral vessels can preserve a clearer view of the
fruit and regional texture; lees contact can add further roundness, while oak
can add aroma and controlled oxygen exposure. New or small barrels can make
wood more obvious. [Oak maturation](../concepts/oak-maturation.md) and
[lees aging](../concepts/lees-aging.md) are separate tools with overlapping
effects.
