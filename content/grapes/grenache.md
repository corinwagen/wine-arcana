...
Garnacha Tinta. The pale-berried Grenache Blanc and Grenache Gris are maintained
as distinct cultivated forms, not alternative names for a red grape. Garnacha
Tintorera is a different variety despite its name. *Alicante* requires particular
care: it is an official Italian synonym for Grenache, but elsewhere may refer to
Alicante Bouschet.
...
suggests. A historical study found that the *aragonés* described in a 1513
agricultural text does not closely match Grenache. It identified a Catalan
reference to *Guarnatxa* in 1564 and a 1629 document as the first unequivocal
reference to black Garnatxa, while a Sardinian document from 1549 mentions
*canonat*.[^2] These records establish sixteenth- and seventeenth-century presence,
not the location where the variety first arose. Ancient Sardinian grape pips show
that viticulture on the island is much older, but resemblance in seed shape cannot
identify a modern cultivar or demonstrate continuous cultivation of Cannonau.[^3]
...
temperatures reduced skin pigments; in Cannonau, sugar accumulation continued
without a matching increase in anthocyanins. Cooler sites, elevation, aspect,
and canopy shade can alter that balance. Yield matters too: France's Plantgrape
catalogue notes that colour falls rapidly as crop level rises. Downy mildew,
phomopsis, grey rot, and poor fruit set in some conditions remain practical risks
even in a variety strongly associated with dry climates.
...
even when the label uses the same varietal name.

Across southern France, Grenache is central to many dry red and rosé blends in
...
[^1]: Federico De Mattia et al., “Genetic relationships between Sardinian and
    ...
    Horticultural Science and Biotechnology* 84, no. 1 (2009), pp. 65–71,
    <https://doi.org/10.1080/14620316.2009.11512481>.
[^2]: Josep M. Puiggròs Jové, “Història dels orígens de la garnatxa negra,”
    *Dossiers Agraris* 19 (2016), pp. 11–32,
    <https://publicacions.iec.cat/repository/pdf/00000244/00000047.pdf>.
[^3]: Mariano Ucchesu et al., “Unearthing Grape Heritage: Morphological
    Relationships between Late Bronze–Iron Age Grape Pips and Modern Cultivars,”
    *Plants* 13 (2024), article 1836,
    <https://doi.org/10.3390/plants13131836>.

## Sources

- Institut français de la vigne et du vin, INRAE & Institut Agro Montpellier,
  [“Grenache N”](https://www.plantgrape.fr/en/varieties/fruit-varieties/120/export),
  Plantgrape varietal record, edited 31 August 2026, accessed 1 September 2026.
- Institut français de la vigne et du vin, INRAE & Institut Agro Montpellier,
  [“Alicante Henri Bouschet
  N”](https://www.plantgrape.fr/en/varieties/fruit-varieties/6/export),
  Plantgrape varietal record, edited 9 January 2026, accessed 1 September 2026.
- Federico De Mattia et al., [“Genetic relationships between Sardinian and
  Spanish viticulture: the case of ‘Cannonau’ and
  ‘Garnacha’”](https://doi.org/10.1080/14620316.2009.11512481), *The Journal of
  Horticultural Science and Biotechnology* 84, no. 1 (2009), pp. 65–71.
- Josep M. Puiggròs Jové, [“Història dels orígens de la garnatxa
  negra”](https://publicacions.iec.cat/repository/pdf/00000244/00000047.pdf),
  *Dossiers Agraris* 19 (2016), pp. 11–32.
- Mariano Ucchesu et al., [“Unearthing Grape Heritage: Morphological
  Relationships between Late Bronze–Iron Age Grape Pips and Modern
  Cultivars”](https://doi.org/10.3390/plants13131836), *Plants* 13 (2024),
  article 1836.
- Ignacio Buesa et al., [“Unraveling the Physiological Mechanisms Underlying the
  Intracultivar Variability of Water Use Efficiency in *Vitis vinifera*
  ‘Grenache’”](https://doi.org/10.3390/plants11213008), *Plants* 11 (2022),
  article 3008.
- Ana Fernandes de Oliveira et al., [“Distinctive Anthocyanin Accumulation
  Responses to Temperature and Natural UV Radiation of Two Field-Grown *Vitis
  vinifera* L. Cultivars”](https://doi.org/10.3390/molecules20022061),
  *Molecules* 20 (2015), pp. 2061–2080.
- G. Masson et al., [“Observatoire Grenache en Vallée du Rhône: incidence du
  terroir sur la composition polyphénolique des raisins et des
  vins”](https://ives-openscience.eu/11641/), *Terroir* 1998, IVES Conference
  Series.
- Olga Pascual et al., [“Influence of grape maturity and prefermentative cluster
  treatment of the Grenache cultivar on wine composition and
  quality”](https://doi.org/10.20870/oeno-one.2016.50.4.1824), *OENO One* 50,
  no. 4 (2016), pp. 169–181.
...
- Institut national de l'origine et de la qualité,
  [“Banyuls Grand Cru”](https://inao.gouv.fr/produit/banyuls-grand-cru-7807),
  appellation record, accessed 1 September 2026.
- RINA Agrifood, [*Cannonau di Sardegna: disciplinare di
  produzione*](https://www.rina.org/it/-/media/Files/agroqualita/vini/sardegna/disciplinari-sardegna/Cannonau-di-Sardegna.pdf),
  production specification, accessed 1 September 2026.
- Wine Australia, [“Grenache—Rebirth of an Australian
  Classic”](https://www.wineaustralia.com/market-insights/regions-and-varieties/grenache),
  accessed 1 September 2026.
