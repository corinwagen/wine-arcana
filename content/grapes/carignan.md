...
## Identity and historical reputation

Its precise birthplace is not documented. French varietal authorities describe
Carignan as Spanish in origin, probably from Aragón, so the apparent connection
between the grape and the town or region of Cariñena should be treated as
plausible naming history rather than conclusive evidence of where the original
vine arose.[^1] The range of Iberian and Mediterranean names records its
movement more securely than it settles that question.
...
Carignan is vigorous, upright, fertile, and late ripening. It is commonly
short-pruned as a bush vine or cordon, which helps restrain a crop that can
...
mildew and possible potassium deficiency. Water
supply, canopy, rootstock, and crop load still affect berry development and
the eventual balance between acidity, colour, and tannin.[^4]
...
[Mourvèdre](mourvedre.md) may moderate its tannic profile or combine it with
other forms of fruit, colour, and texture. [Carbonic
maceration](../concepts/carbonic-maceration.md), which ferments whole berries
in a carbon-dioxide-rich environment, is also a traditional route to a more
supple, fruit-forward expression. A lightly extracted early-drinking red and a
firm wine intended to develop in bottle can begin with the same grape.

## Mediterranean reappraisal

Carignan remains most closely associated with the western Mediterranean: the
Languedoc and Roussillon in France, north-eastern Spain, and parts of Sardinia.
In Rioja, Mazuelo is a minority authorized grape that can contribute acidity,
tannin, aroma, or colour alongside [Tempranillo](tempranillo.md) and other
...
[^2]: Institut français de la vigne et du vin, INRAE & Institut Agro
    Montpellier, “Carignan N,” Plantgrape varietal record.
[^3]: Hugo Fernandez-Mena et al., “Vineyard design and plant material choices
    effect on grapevine yield: analysis of a big dataset in the south of
    France,” *Agronomy for Sustainable Development* 45 (2025), article 16,
    <https://doi.org/10.1007/s13593-025-01012-7>.
[^4]: Institut français de la vigne et du vin, INRAE & Institut Agro
    Montpellier, “Carignan N,” Plantgrape varietal record.
[^5]: Consejo Regulador de la Denominación de Origen Calificada Rioja,
    “Mazuelo,” accessed 3 September 2026.
...
- Institut français de la vigne et du vin, INRAE & Institut Agro Montpellier,
  [“Carignan N”](https://www.plantgrape.fr/en/varieties/fruit-varieties/53/export),
  Plantgrape varietal record, edited 19 August 2026, accessed 3 September 2026.
- Peter Dry, [“Carignan”](https://www.awri.com.au/wp-content/uploads/2021/05/s2163.pdf),
  *Wine & Viticulture Journal* 35, no. 2 (2020), Australian Wine Research
  Institute.
- Hugo Fernandez-Mena et al., [“Vineyard design and plant material choices
  effect on grapevine yield: analysis of a big dataset in the south of
  France”](https://doi.org/10.1007/s13593-025-01012-7), *Agronomy for
  Sustainable Development* 45 (2025), article 16.
- Consejo Regulador de la Denominación de Origen Calificada Rioja,
  [“Mazuelo”](https://riojawine.com/en-us/the-designation/grape-varieties/mazuelo/),
